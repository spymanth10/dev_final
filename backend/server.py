...
try:
    xgb_model = joblib.load(r'Movie-Success-Prediction-System-main/backend/xgb_model.pkl')
    word2vec = gensim.models.Word2Vec.load(r'C:\Users\shike\Desktop\Movie-Success-Prediction-System-main\Movie-Success-Prediction-System-main\backend\word2vec_genres.model')
    label_encoder = joblib.load(r'C:\Users\shike\Desktop\Movie-Success-Prediction-System-main\Movie-Success-Prediction-System-main\backend\label_encoders.pkl')
...
@app.route('/')
def home():
    return "Movie Success Prediction API is running!", 200
